...
#include "emo_voice_interfaces/srv/detail/gen_text__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = emo_voice_interfaces::srv::GenText_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const emo_voice_interfaces::srv::GenText_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<emo_voice_interfaces::srv::GenText_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GenText_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const emo_voice_interfaces::srv::GenText_Request *>(
...
static size_t _GenText_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GenText_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GenText_Request__callbacks = {
...
static rosidl_message_type_support_t _GenText_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GenText_Request__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_emo_voice_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<emo_voice_interfaces::srv::GenText_Request>()
{
  return &emo_voice_interfaces::srv::typesupport_fastrtps_cpp::_GenText_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = emo_voice_interfaces::srv::GenText_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const emo_voice_interfaces::srv::GenText_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<emo_voice_interfaces::srv::GenText_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GenText_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const emo_voice_interfaces::srv::GenText_Response *>(
...
static size_t _GenText_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GenText_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GenText_Response__callbacks = {
  "emo_voice_interfaces::srv",
  "GenText_Response",
...
static rosidl_message_type_support_t _GenText_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GenText_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &emo_voice_interfaces::srv::typesupport_fastrtps_cpp::_GenText_Response__handle;
}
...
static service_type_support_callbacks_t _GenText__callbacks = {
  "emo_voice_interfaces::srv",
  "GenText",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, emo_voice_interfaces, srv, GenText_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, emo_voice_interfaces, srv, GenText_Response)(),
...
static rosidl_service_type_support_t _GenText__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GenText__callbacks,
...
{
  return &emo_voice_interfaces::srv::typesupport_fastrtps_cpp::_GenText__handle;
}
