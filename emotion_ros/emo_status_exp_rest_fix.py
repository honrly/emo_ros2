...
class EmoStatusNode(Node):
    def __init__(self):
        ...
        self.pulse_csv_filename = os.path.join(bio_pulse_data_path, f'{timestamp}_rest_fix.csv')
        ...
        self.brain_csv_filename = os.path.join(bio_pulse_data_path, f'{timestamp}_rest_fix.csv')
        ...
        self.emo_csv_filename = os.path.join(emo_data_path, f'{timestamp}_rest_fix.csv')
