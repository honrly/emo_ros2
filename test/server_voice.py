...
class VoiceNode(Node):
    def __init__(self):
        ...
        self.pub_voice = self.create_publisher(Int32MultiArray, 'voice', 10)
        self.voice_data = Int32MultiArray()
        self.voice_data.data = []
        
    def gen_text_callback(self, request, response):
        self.get_logger().info(f'{request.emo}')
        ...
        self.get_logger().info(f'{res_gemini.text}')
        ...
        self.voice_data.data = voice_int
        self.pub_voice.publish(self.voice_data)
